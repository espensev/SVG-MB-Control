...
| Requirement | Verify | Verification home | Result |
|---|---|---|---|
| `REQ-CPUEFF-01` | T, M | Work-counter (APERF/MPERF) delta-math unit/smoke test; runtime CSV evidence on a supported machine. | deferred — not yet implemented (energy-only first cut); reachable with the shipped bin (AMD RO aliases 0xC00000E7/0xC00000E8; the 2026-06-07 #GP was a probe-index error), corrected live read passed 2026-06-09, a near-term cycle-path addition |
