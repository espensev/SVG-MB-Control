...
| HP-2 | G2 | `snapshot_age_ms` re-parses an ISO string the sampler just formatted (`runtime_csv_rows.cpp:424-427`) | Historical control-optimization register was folded into `docs/control-latency-reduction-design-2026-06-18.md`; trivial vs hardware-read budget |
