...
> **PREP VERIFIED 2026-06-25 (CORRECTED) — pre-check PASS for control identity, but the literal `--profile` Option A is INVALID. Deploy mechanism deferred (A2 vs B); no live action taken.**
