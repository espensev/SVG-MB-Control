...
| [FEAT-0010](FEAT-0010-write-actuation-sidecar-fault.md) | Write actuation survives a sidecar-persistence fault (sidecar persist failure must not veto the fan write) | `REQ-WRITESAFE-*` | Accepted (build-authorized 2026-06-17; runtime-reproduced H1) |
