...
| [FEAT-0011](FEAT-0011-write-failure-breaker-rising-cooling-demand.md) | Write-failure breaker must not block rising cooling demand (recovered-actuator self-heal in the cooling direction) | `REQ-COOLWRITE-*` | Implemented (2026-06-17; bounded half-open probe — one write per 5 s on rising cooling demand closes a recovered breaker; C++ tests green) |
